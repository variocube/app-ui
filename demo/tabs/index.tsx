	...
	return (
		<Container maxWidth="md">
			...
			<Box sx={{mb: 4}}>
				...
				<Box sx={{mb: 4}}>
					<Typography variant="body1" gutterBottom>
						Tabs can also use the component property to render a link. This can be used in combination with
						a router.
					</Typography>
				</Box>
				<Tabs
