...
import {Code, createSimpleTFunc, EditForm, PageTitle, SearchForm, TextField} from "../../src";
		...
		<Container>
			<Stack spacing={2}>
				...
				<Typography variant="body1">
					An edit form has a save button and has a loading state both while loading the data and while saving
					the data.
				</Typography>
				<EditFormDemo />
				<Typography variant="h2" gutterBottom>
			...
			<Card>
				<CardContent>
					<Typography variant="body2">
						In this demo we emulate loading data from a server and saving it back. This card shows the
						current state of the (emulated) server data.
					</Typography>
				</CardContent>
				<CardContent>
					<Typography variant="body1">
