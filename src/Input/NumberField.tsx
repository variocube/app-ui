...
export function NumberField({numberValue, onChangeNumber, onChange, onFocus, onBlur, onKeyPress, numberFormat, invalidMessage, helperText, ...props}: NumberFieldProps) {
    ...
    const handleChange = useCallback((e) => {
        ...
        onChange && onChange(e);
    }, [thousandSeparator, decimalSeparator, onChange]);
