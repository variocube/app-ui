import {DateTimeFormat, Now, PlainDate, PlainDateTime} from "../temporal";
import {DateIOFormats, Unit} from "@date-io/core/IUtils";
import {getFormatString} from "./getFormatString";

export class PlainAdapterCommon<T extends PlainDate | PlainDateTime> {
    ...
    getWeekdays(): string[] {
        const today = Now.plainDate("gregory");
